...
interface DarkMode {
  isDarkMode: boolean;
  setIsDarkMode: React.MouseEventHandler<HTMLButtonElement>;
}

const About = ({ isDarkMode, setIsDarkMode }: DarkMode) => {
  return (
    <div>
                ...
                <div className="lg:order-first lg:row-span-2">
                  ...
                  <div className="mt-6 space-y-7 text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
                    <p>
                      ...
                      back-end technologies to create dynamic and user-friendly
                      web applications. With a passion for building scalable and
                      efficient systems, I enjoy solving complex problems and
                      implementing innovative solutions that make a difference
                    ...
                    <p>
                      ...
                      frameworks such as Next.js and React Native, which allow
                      me to build responsive, dynamic, and mobile-friendly web
                      pages. I also pay attention to accessibility and usability
                    ...
                    <p>
                      ...
                      on creating well-structured and maintainable code, I
                      strive to create back-end systems that enable seamless
                      communication with the front-end and provide a smooth user
                      experience.
                    </p>
                    <p>
                      In short, I am a full stack web developer who is
                      passionate about delivering high-quality and user-centric
                      web applications. Whether it&apos;s working on a new
                      project from scratch or enhancing an existing one, I am
                      always looking for ways to push the boundaries of
                      what&apos;s possible with web development.
                    </p>
                  </div>
                </div>
                <div className="lg:pl-20">
